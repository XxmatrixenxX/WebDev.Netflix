...
function NetflixViewModel() {
    ...
    self.watchedMovies = new MovieList("Nochmal ansehen", [
        ...
        new Movie("Penguin of Madagascar","Eric Darnelle", 2014, ["Tom McGrath", "Chrisopher Knights", "Chris Miller"], "Die Pinguin-Spione Skipper, Kowalski, Rico und Private wollen zusammen mit den schnittigen Nordwind-Agenten das machthungrige Genie Octavius Brine besiegen.", "img/Pinguin aus Madagaskar.webp"),
